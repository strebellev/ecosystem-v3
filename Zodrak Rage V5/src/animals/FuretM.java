...
public class FuretM {
	...
	public FuretM(PVector l, DNAfuret dnafuret_, PApplet p){
		parent = p;
		position = l.get();
		xoff = p.random(3200);
		yoff = p.random(3200);
		...
		health = PApplet.map(dnafuret.genes[0], 0, 1, 50, 250);
		r = PApplet.map(dnafuret.genes[0], 0, 1, 4, 8);
		//maxspeed = PApplet.map(dnafuret.genes[0], 0, 1, 1, 2);
		lifeTime = PApplet.map(dnafuret.genes[0], 0, 1, 100, 250);
		maxLifeTime = PApplet.map(dnafuret.genes[0], 0, 1, 100, 250);
		//water = PApplet.map(dnafuret.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnafuret.genes[1], 0, 1, 100, 200);
		
		speed = PApplet.map(dnafuret.genes[0], 0, 1, 1, 2);
		...
		//////test anim/////
		animLeft[0] = p.loadImage("res/animal/furet/furetL0.png");
		animLeft[1] = p.loadImage("res/animal/furet/furetL1.png");
		animLeft[2] = p.loadImage("res/animal/furet/furetL2.png");
		
		animRight[0] = p.loadImage("res/animal/furet/furetR0.png");
		animRight[1] = p.loadImage("res/animal/furet/furetR1.png");
		animRight[2] = p.loadImage("res/animal/furet/furetR2.png");
			
		animUp[0] = p.loadImage("res/animal/furet/furetU0.png");
		animUp[1] = p.loadImage("res/animal/furet/furetU1.png");
		animUp[2] = p.loadImage("res/animal/furet/furetU2.png");
			
		animDown[0] = p.loadImage("res/animal/furet/furetD0.png");
		animDown[1] = p.loadImage("res/animal/furet/furetD1.png");
		animDown[2] = p.loadImage("res/animal/furet/furetD2.png");
	...
	public ArrayList<PVector> getFuretM(){
		return furetm;
	}
