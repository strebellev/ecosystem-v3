...
public class LapinF {
	...
	public LapinF(PVector l, DNAlapin dnalapin_, PApplet p){
		parent = p;
		position = l.get();
		xoff = p.random(3200);
		yoff = p.random(3200);
		...
		lifeTime = PApplet.map(dnalapin.genes[0], 0, 1, 100, 250);
		maxLifeTime = PApplet.map(dnalapin.genes[0], 0, 1, 100, 250);
		//water = PApplet.map(dnalapin.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnalapin.genes[1], 0, 1, 100, 200);
		
		speed = PApplet.map(dnalapin.genes[0], 0, 1, 1, 2);
		...
		//////test anim/////
		animLeft[0] = p.loadImage("res/animal/lapin/lapinL0.png");
		animLeft[1] = p.loadImage("res/animal/lapin/lapinL1.png");
		animLeft[2] = p.loadImage("res/animal/lapin/lapinL2.png");
		
		animRight[0] = p.loadImage("res/animal/lapin/lapinR0.png");
		animRight[1] = p.loadImage("res/animal/lapin/lapinR1.png");
		animRight[2] = p.loadImage("res/animal/lapin/lapinR2.png");
			
		animUp[0] = p.loadImage("res/animal/lapin/lapinU0.png");
		animUp[1] = p.loadImage("res/animal/lapin/lapinU1.png");
		animUp[2] = p.loadImage("res/animal/lapin/lapinU2.png");
			
		animDown[0] = p.loadImage("res/animal/lapin/lapinD0.png");
		animDown[1] = p.loadImage("res/animal/lapin/lapinD1.png");
		animDown[2] = p.loadImage("res/animal/lapin/lapinD2.png");
	...
	public ArrayList<PVector> getLapinF(){
		return lapinf;
	}
