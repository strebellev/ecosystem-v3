...
public class BoarF {
	...
	public BoarF(PVector l, DNAboar dnaboar_, PApplet p){
		...
		lifeTime = PApplet.map(dnaboar.genes[0], 0, 1, 100, 250);
		maxLifeTime = PApplet.map(dnaboar.genes[0], 0, 1, 100, 250);
		//water = PApplet.map(dnaboar.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnaboar.genes[1], 0, 1, 100, 200);
		
		speed = PApplet.map(dnaboar.genes[0], 0, 1, 1, 2);
