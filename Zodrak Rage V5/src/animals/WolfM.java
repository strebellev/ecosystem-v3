...
public class WolfM {
	...
	public WolfM(PVector l, DNAwolf dnawolf_, PApplet p){
		...
		lifeTime = PApplet.map(dnawolf.genes[0], 0, 1, 100, 250);
		maxLifeTime = PApplet.map(dnawolf.genes[0], 0, 1, 100, 250);
		//water = PApplet.map(dnawolf.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnawolf.genes[1], 0, 1, 100, 200);
		
		speed = PApplet.map(dnawolf.genes[0], 0, 1, 1, 2);
