...
public class BearF {
	...
	public BearF(PVector l, DNAbear dnabear_, PApplet p){
		parent = p;
		position = l.get();
		xoff = p.random(3200);
		yoff = p.random(3200);
		...
		lifeTime = PApplet.map(dnabear.genes[0], 0, 1, 100, 250);
		maxLifeTime = PApplet.map(dnabear.genes[0], 0, 1, 100, 250);
		//water = PApplet.map(dnabear.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnabear.genes[1], 0, 1, 100, 200);
		
		speed = PApplet.map(dnabear.genes[0], 0, 1, 1, 2);
		...
		//////test anim/////
		animLeft[0] = p.loadImage("res/animal/bear/bearL0.png");
		animLeft[1] = p.loadImage("res/animal/bear/bearL1.png");
		animLeft[2] = p.loadImage("res/animal/bear/bearL2.png");
		
		animRight[0] = p.loadImage("res/animal/bear/bearR0.png");
		animRight[1] = p.loadImage("res/animal/bear/bearR1.png");
		animRight[2] = p.loadImage("res/animal/bear/bearR2.png");
			
		animUp[0] = p.loadImage("res/animal/bear/bearU0.png");
		animUp[1] = p.loadImage("res/animal/bear/bearU1.png");
		animUp[2] = p.loadImage("res/animal/bear/bearU2.png");
			
		animDown[0] = p.loadImage("res/animal/bear/bearD0.png");
		animDown[1] = p.loadImage("res/animal/bear/bearD1.png");
		animDown[2] = p.loadImage("res/animal/bear/bearD2.png");
	...
	public ArrayList<PVector> getBearF(){
		return bearf;
	}
