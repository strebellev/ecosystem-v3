...
public class BlaireauM {
	PApplet parent;
	ArrayList<PVector> blaireaum;
	...
	public BlaireauM(PVector l, DNAblaireau dnablaireau_, PApplet p){
		parent = p;
		position = l.get();
		xoff = p.random(3200);
		yoff = p.random(3200);
		...
		lifeTime = PApplet.map(dnablaireau.genes[0], 0, 1, 100, 250);
		maxLifeTime = PApplet.map(dnablaireau.genes[0], 0, 1, 100, 250);
		//water = PApplet.map(dnablaireau.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnablaireau.genes[1], 0, 1, 100, 200);
		
		speed = PApplet.map(dnablaireau.genes[0], 0, 1, 1, 2);
		...
		//////test anim/////
		animLeft[0] = p.loadImage("res/animal/blaireau/blaireauL0.png");
		animLeft[1] = p.loadImage("res/animal/blaireau/blaireauL1.png");
		animLeft[2] = p.loadImage("res/animal/blaireau/blaireauL2.png");
		
		animRight[0] = p.loadImage("res/animal/blaireau/blaireauR0.png");
		animRight[1] = p.loadImage("res/animal/blaireau/blaireauR1.png");
		animRight[2] = p.loadImage("res/animal/blaireau/blaireauR2.png");
			
		animUp[0] = p.loadImage("res/animal/blaireau/blaireauU0.png");
		animUp[1] = p.loadImage("res/animal/blaireau/blaireauU1.png");
		animUp[2] = p.loadImage("res/animal/blaireau/blaireauU2.png");
			
		animDown[0] = p.loadImage("res/animal/blaireau/blaireauD0.png");
		animDown[1] = p.loadImage("res/animal/blaireau/blaireauD1.png");
		animDown[2] = p.loadImage("res/animal/blaireau/blaireauD2.png");
	...
	public ArrayList<PVector> getBlaireauM(){
		return blaireaum;
	}
